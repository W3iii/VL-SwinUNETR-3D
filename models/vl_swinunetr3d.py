...
# ─────────────────────────────────────────────────────────────────────────────
# 2.  Language-Vision Fusion Module  (LAVT-style)
# ─────────────────────────────────────────────────────────────────────────────
...
class LanguageVisionFusion(nn.Module):
    ...
    5. Reshape fused tokens (B, N, C) → (B, C, H, W, D)
    ...
    def forward(
        ...
        fused_tokens = self.norm(visual_tokens + attended)  # (B, N, C)

        # ── Step 5: Reshape back to 3D feature map ────────────────────────
